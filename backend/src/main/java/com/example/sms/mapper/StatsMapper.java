...
public interface StatsMapper {
    ...
    /** 全校成绩分数段分布 */
    @Select("SELECT CASE WHEN score < 60 THEN '60分以下' WHEN score < 70 THEN '60-69分' " +
            "WHEN score < 80 THEN '70-79分' WHEN score < 90 THEN '80-89分' ELSE '90-100分' END AS name, " +
            "COUNT(*) AS value FROM student_course WHERE score IS NOT NULL " +
